...
{
     "name": "Document Page",
     "summary": "Manage knowledge pages with categories, history and diffs.",
     "description": """
     Document pages (knowledge base) with categories, attachments, history tracking and diff view.
     Includes wizards to create menus and display changes between revisions.
     """,
     "version": "19.0.1.0.0",
